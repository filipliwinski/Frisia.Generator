...
namespace Frisia.Generator.Demo
{
    class Program
    {
        ...
        private static readonly string versionString = string.Format("v.{0}.{1}.{2}", version.Major, version.Minor, version.Build);
            ...
            bool writeRewrittenCodeToFile)
        {
            ...
            foreach (var path in paths)
            {
                ...
                {
                    var rewrittenNodeText = $"// This code was generated by Frisia.Generator.Demo ({versionString}).{Environment.NewLine}// Date: {DateTime.Now.ToString("dd-MM-yyyy HH:mm:ss")}{Environment.NewLine}// Time: {elapsed}{Environment.NewLine}{Environment.NewLine}{rewrittenNode.SyntaxTree}";
