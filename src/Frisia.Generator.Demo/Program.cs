    ...
    class Program
    {
            ...
            bool writeRewrittenCodeToFile)
        {
            ...
            foreach (var path in paths)
            {
                ...
                {
                    var rewrittenNodeText = $"// This code was generated by {appName}.{Environment.NewLine}// Date: {DateTime.Now.ToString("dd-MM-yyyy HH:mm:ss")}{Environment.NewLine}// Time: {elapsed}{Environment.NewLine}{Environment.NewLine}{rewrittenNode.SyntaxTree}";
